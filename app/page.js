        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="max-w-screen-lg text-gray-500 sm:text-lg dark:text-gray-400">
            ...
            <p className="mb-4 font-medium">
              ...
              daily, weekly, or bi-weekly. Focus on your core business while we
              ensure a consistently clean and healthy environment.
            </p>
          </div>
        </div>
      </section>
        ...
        <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
          <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
            ...
            <p class="mb-4">
              ...
              organization and tailoring our cleaning services accordingly. Our
              approach ensures that we meet and exceed expectations.
            </p>
            <p>
            ...
            <div className="p-4 md:w-1/3 flex">
              ...
              <div className="flex-grow pl-6">
                ...
                <p className="leading-relaxed text-base">
                  Our experienced team provides thorough and efficient cleaning
                  services to ensure a clean and healthy environment for all
                  students and staff. From classrooms to common areas we cover
                  it all.
                </p>
              </div>
            </div>
            <div className="p-4 md:w-1/3 flex">
              ...
              <div className="flex-grow pl-6">
                ...
                <p className="leading-relaxed text-base">
                  ...
                  crucial. Our disinfection services utilize advances techniques
                  an products to effectively eliminate germs and viruses,
